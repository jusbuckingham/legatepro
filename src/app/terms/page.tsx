    ...
    <main className="min-h-[calc(100vh-1px)] bg-background px-4 py-10 text-foreground">
      <div className="mx-auto w-full max-w-3xl">
        <div className="rounded-2xl border border-border bg-card p-6 shadow-sm sm:p-8">
          ...
          <section className="mt-8 space-y-3">
            ...
            <p className="text-sm text-muted-foreground">
              ...
              <a
                ...
                className="font-medium text-rose-600 hover:text-rose-500 hover:underline focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-rose-500/25 focus-visible:ring-offset-2 focus-visible:ring-offset-background"
              >
          ...
          <section className="mt-10 rounded-xl border border-amber-500/30 bg-amber-500/10 p-4 text-sm text-foreground">
            <p className="text-sm text-muted-foreground">
              <strong className="text-foreground">Important disclaimer:</strong> LegatePro does not replace a
