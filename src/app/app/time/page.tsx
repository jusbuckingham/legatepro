  ...
  return (
    <div className="space-y-6 p-6">
      ...
      <div className="flex flex-col gap-3 border-b border-slate-800 pb-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
          <h1 className="text-xl font-semibold text-slate-50">Time</h1>
          <p className="text-sm text-slate-400">
            Track and analyze time spent across all estates.
          </p>
        </div>
        <div className="flex gap-2">
          <Link
            href="/app/estates"
            className="rounded-md border border-slate-700 bg-slate-900 px-3 py-1.5 text-xs font-medium text-slate-100 hover:border-slate-500 hover:bg-slate-800"
          >
            View Estates
          </Link>
        </div>
      ...
      <form
        method="GET"
        className="flex flex-col gap-3 rounded-lg border border-slate-800 bg-slate-950/70 p-4 text-xs sm:flex-row sm:items-end sm:justify-between"
      >
                  ...
                  return (
                    ...
                    >
                      ...
                      <td className="px-4 py-2 align-top text-slate-300">
                        {/* For now we just show a placeholder; can wire real task label later */}
                        {entry.taskId
