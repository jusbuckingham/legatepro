...
export const ESTATE_EVENT_TYPES = [
  ...
  // Invoice status lifecycle (specific)
  "INVOICE_SENT",
  "INVOICE_MARKED_PAID",
  "INVOICE_MARKED_OVERDUE",
  "INVOICE_VOIDED",
  "INVOICE_REVERTED_TO_DRAFT",

  // Fallback / generic status change
...
export const ESTATE_EVENT_TYPE_ALIASES = {
  ...
  NOTE_PIN: "NOTE_PINNED",
  NOTE_UNPIN: "NOTE_UNPINNED",
  NOTE_REMOVED: "NOTE_DELETED",
  ...
  INVOICE_PAID: "INVOICE_MARKED_PAID",
  INVOICE_OVERDUE: "INVOICE_MARKED_OVERDUE",
  INVOICE_VOID: "INVOICE_VOIDED",
  INVOICE_DRAFT: "INVOICE_REVERTED_TO_DRAFT",

  // Legacy generic
  INVOICE_STATUS_UPDATED: "INVOICE_STATUS_CHANGED",

  // Collaborators / Invites
  INVITE_ACCEPTED: "COLLABORATOR_INVITE_ACCEPTED",

  // Contacts
  CONTACT_ADDED: "CONTACT_LINKED",
  CONTACT_REMOVED: "CONTACT_UNLINKED",

  PROPERTY_ADDED: "PROPERTY_CREATED",
  PROPERTY_UPDATED: "PROPERTY_UPDATED",
  PROPERTY_REMOVED: "PROPERTY_DELETED",
  RENT_PAYMENT_REMOVED: "RENT_PAYMENT_DELETED",
} as const;
